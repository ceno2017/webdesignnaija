...
export const metadata = {
  title: "Web design in Uyo, SEO in Uyo",
  description:
    "We focus on our client's satisd=faction as rfegards web design and web app development in Uyo",
  keywords:
    "website design Uyo,web design company Uyo,website developers in Uyo,affordable web design Uyo,ecommerce website design Uyo,responsive web design Uyo,professional website design Uyo,best web design agency Uyo,business website design Uyo",
};
...
export default function WebDesignLandingPage() {
  return (
    <>
      <Head>
        <title>
          Professional Web Designer for Hire in Uyo| Modern SEO‑Optimized
          Websites in Uyo
        </title>
        <meta
          name="description"
          content="Hire a professional web designer for modern, fast, SEO‑optimized websites in Uyo. I design business websites, landing pages, and web apps that convert visitors into clients in Uyo."
        />
        <meta
          name="keywords"
          content="web designer for hire in Uyo, web design services in Uyo, SEO web design, Next.js developer"
        />
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="mt-6 text-lg text-slate-300">
              We help startups, businesses, and entrepreneurs in Uyo and River
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            {[
              ...
              {
                name: "SEO enhancements for existing sites in Uyo",
