...
export const metadata = {
  title: "Web design in Warri, SEO in Warri",
  description:
    "We focus on our client's satisd=faction as rfegards web design and web app development in Warri",
  keywords:
    "website design Warri,web design company Warri,website developers in Warri,affordable web design Warri,ecommerce website design Warri,responsive web design Warri,professional website design Warri,best web design agency Warri,business website design Warri,Hotel management system",
};
...
export default function WebDesignLandingPage() {
  return (
    <>
      <Head>
        <title>
          Professional Web Designer for Hire in Warri| Modern SEO‑Optimized
          Websites in Warri
        </title>
        <meta
          name="description"
          content="Hire a professional web designer for modern, fast, SEO‑optimized websites in Warri. I design business websites, landing pages, and web apps that convert visitors into clients in Warri."
        />
        <meta
          name="keywords"
          content="web designer for hire in Warri, web design services in Warri, SEO web design, Next.js developer"
        />
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="mt-6 text-lg text-slate-300">
              We help startups, businesses, and entrepreneurs in Warri and River
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            {[
              {
                name: "Hotel management systems in Warri",
              ...
              {
                name: "SEO enhancements for existing sites in Warri",
