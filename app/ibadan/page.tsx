...
export const metadata = {
  title: "Web design in Ibadan, SEO in Ibadan",
  description:
    "We focus on our client's satisd=faction as rfegards web design and web app development in Ibadan",
  keywords:
    "website design Ibadan,web design company Ibadan,website developers in Ibadan,affordable web design Ibadan,ecommerce website design Ibadan,responsive web design Ibadan,professional website design Ibadan,best web design agency Ibadan,business website design Ibadan,Hotel management system",
};
...
export default function WebDesignLandingPage() {
  return (
    <>
      <Head>
        <title>
          Professional Web Designer for Hire in Ibadan| Modern SEO‑Optimized
          Websites in Ibadan
        </title>
        <meta
          name="description"
          content="Hire a professional web designer for modern, fast, SEO‑optimized websites in Ibadan. I design business websites, landing pages, and web apps that convert visitors into clients in Ibadan."
        />
        <meta
          name="keywords"
          content="web designer for hire in Ibadan, web design services in Ibadan, SEO web design, Next.js developer"
        />
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="mt-6 text-lg text-slate-300">
              We help startups, businesses, and entrepreneurs in Ibadan and
              River state of Nigeria stand out online with fast,
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            {[
              {
                name: "Hotel management systems in Ibadan",
              ...
              {
                name: "SEO enhancements for existing sites in Ibadan",
