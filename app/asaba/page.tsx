...
export const metadata = {
  title: "Web design in Asaba, SEO in Asaba",
  description:
    "We focus on our client's satisd=faction as rfegards web design and web app development in Asaba",
  keywords:
    "website design Asaba,web design company Asaba,website developers in Asaba,affordable web design Asaba,ecommerce website design Asaba,responsive web design Asaba,professional website design Asaba,best web design agency Asaba,business website design Asaba,Hotel management system",
};
...
export default function WebDesignLandingPage() {
  return (
    <>
      <Head>
        <title>
          Professional Web Designer for Hire in Asaba| Modern SEO‑Optimized
          Websites in Asaba
        </title>
        <meta
          name="description"
          content="Hire a professional web designer for modern, fast, SEO‑optimized websites in Asaba. I design business websites, landing pages, and web apps that convert visitors into clients in Asaba."
        />
        <meta
          name="keywords"
          content="web designer for hire in Asaba, web design services in Asaba, SEO web design, Next.js developer"
        />
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="mt-6 text-lg text-slate-300">
              We help startups, businesses, and entrepreneurs in Asaba and River
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            {[
              {
                name: "Hotel management systems in Asaba",
              ...
              {
                name: "SEO enhancements for existing sites in Asaba",
